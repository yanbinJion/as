...
public class ImagesFragment extends BaseFragment {
    ...
    public static ImagesFragment getInstance(List<Channel> listChannels) {
        ImagesFragment sf = new ImagesFragment();
        sf.channelList = listChannels;
        return sf;
    }
    public static ImagesFragment getInstance(List<Channel> listChannels, Boolean ishowvp) {
        ImagesFragment sf = new ImagesFragment();
        sf.channelList = listChannels;
        sf.ishowvp = ishowvp;
        return sf;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (null == mImage) {
            mImage = inflater.inflate(R.layout.fragment_image, null);
        }
    ...
    private void initData(List<AppConfigBean.Module.Channel> channelItems) {
        fragmentList.clear();
        mTabEntities.clear();
        int k = 0;
        ...
        if (ishowvp) {
            ...
            comtab.setTabData(mTabEntities, this.getActivity(), R.id.fl_content, fragmentList);
