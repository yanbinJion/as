                ...
                if (voGlobal != null) {
                    initTitleBar(voGlobal.getSpecialname(), R.drawable.img_share, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ShareUtils.shareSdk(ProDetailContentActivity.this, voGlobal.getSpecialname(), voGlobal.getDesc(), voGlobal.getPic(), key, Const.SHARE_API.PROJECT,umShareListener);
                        }
                    });
