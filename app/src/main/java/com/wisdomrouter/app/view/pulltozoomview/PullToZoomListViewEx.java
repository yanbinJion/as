package com.wisdomrouter.app.view.pulltozoomview;
...
public class PullToZoomListViewEx extends PullToZoomBase<ListView> implements AbsListView.OnScrollListener {
    ...
    public void setHead(View view) {
        mRootView.addHeaderView(view);
    }

//    public void setOnScroll() {
//        mRootView.setOnScrollListener(new AbsListView.OnScrollListener() {
//            @Override
...
//    }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        if (mZoomView != null && !isHideHeader() && isPullToZoomEnabled()) {
            ...
            if (scrollListener != null) {
                scrollListener.onPullScroll(firstVisibleItem);
            }
    ...
    public interface onPullScrollListener {
        void onPullScroll(int position);
    }

    private onPullScrollListener scrollListener;

    public void setOnPullScrollListener(onPullScrollListener scrollListener) {
